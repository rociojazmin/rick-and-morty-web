...
export const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-gray-800 text-primary-content">
            <div>
                <img
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Cartoon_Network_logo_%282004-2010%29.svg/1000px-Cartoon_Network_logo_%282004-2010%29.svg.png"
                ...
                <p className="font-bold text-gray-400">
                    Cartoon Network Industries. <br />Redraw your world
                </p>
